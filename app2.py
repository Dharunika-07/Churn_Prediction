...
MODEL_FILES = {
    ...
    'scaler': {'filename': 'scaler_model1.pkl', 'expected_md5': None},
        ...
        try:
            ...
            try:
                 with open("pca_model.pkl", "rb") as file:
                    ...
                    print("Loaded")
                    self.models['pca'] = loaded_pca
                    print("PCA model loaded successfully")
            except Exception as e:
                raise Exception(f"Failed to load PCA model: {str(e)}")
            try:
                 with open("scaler_model1.pkl", "rb") as file:
                    loaded_scaler = pickle.load(file)
                    print("Loaded")
                    self.models['scaler'] = loaded_scaler
                    print("Scaler model loaded successfully")
            except Exception as e:
                raise Exception(f"Failed to load Scaler model: {str(e)}")
